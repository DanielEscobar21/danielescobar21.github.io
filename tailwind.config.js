...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Simplificamos a una paleta monocromática
        neutral: {
          50: '#fafafa',
          100: '#f5f5f5',
          200: '#e5e5e5',
      ...
      boxShadow: {
        ...
        'soft-lg': '0 10px 25px -3px rgba(0, 0, 0, 0.05), 0 20px 45px -2px rgba(0, 0, 0, 0.03)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-dots': 'radial-gradient(circle, var(--tw-gradient-stops))',
